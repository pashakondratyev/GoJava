...
public class basicGoLite {
	...
	public static Cast castUtil = new Cast();
		...
		String __golite__e_1 = new String("")
		
		Integer __golite__int_1 = new Integer(0)
		
		Double __golite__float64_1 = new Double(0.0)
		
		Boolean __golite__bool_1 = new Boolean(false)
		
		Character __golite__rune_1 = new Character(' ')
		
		String __golite__string_1 = new String("")
